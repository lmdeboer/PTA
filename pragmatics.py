...
def sentiment_analysis_tb(text):
    ...
    necessary objects for spacy. Moreover, the 10 most common
    high-sentiment words per text are found by using a defaultdict.
    This dictionary is returned together with the subjectivity
    and polarity of the text. The pattern of certain words being
    exclusively in AI-generated texts is evaluated.
    :param text: Text of articles
    :return: text subjectivity, polarity, dictionary with 10 most common
    high-sentiment words per text
    """
    # Load spacy pipeline
    ...
    # Add words to a list
    assessments = [assessment for assessment
    ...
    # sort dictionary
    sorted_word_frequency = sorted(word_frequencies.items(),
...
def sentiment_ratios(text):
    ...
    negative sentences, and the distribution of positive versus negative
    sentences are found. If the results are significantly different based
    on whether the text is AI-generated or not, a new pattern is established
    and the text is evaluated based on that. Finally, the variables of this
    ...
    # calculate percentage of high-sentiment sentences in
...
def sentiment_analysis_asent(text):
    ...
    objects for spacy. It evaluates whether the text is AI-generated
    based on a pattern. The evaluation and polarity of the
    text are returned.
    """
    nlp = spacy.blank('en')
    ...
    # pattern: in the development data, the compound score for human text was
...
def discourse_analysis(text):
    ...
    Entity Grid features, as well as
    readability functions. It first establishes the necessary preprocessing
    and then calls the necessary methods,
    finally returning them.
    :param text: articles
    :return: Entity Density, Entity Grid Features, Readability Features
    for both parameters
    """
